...
public class PhoneUtils {
    ...
    public static String getUniquePsuedoID() {
        ...
        try {
            ...
            serial = Settings.System.getString(MyApplication.instance.getContentResolver(), Settings.System.ANDROID_ID);
    ...
    public static int getSimCount() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
            try {
                SubscriptionManager mSubscriptionManager = (SubscriptionManager) MyApplication.instance.getSystemService(Context.TELEPHONY_SUBSCRIPTION_SERVICE);
    ...
    public static List<SimInfo> getSimMultiInfo() {
        ...
        ContentResolver resolver = MyApplication.instance.getContentResolver();
        ...
        if(infos.isEmpty()){
            TelephonyManager tm = (TelephonyManager)MyApplication.instance.getSystemService(Context.TELEPHONY_SERVICE);
            SimInfo simInfo = new SimInfo();
            simInfo.mImsi= tm.getSubscriberId();//得到用户Id
            simInfo.mImei= tm.getSimSerialNumber();//获得SIM卡的序号
            simInfo.mNumber = tm.getLine1Number();//获取本机号码
            simInfo.mCarrierName = tm.getSubscriberId();
            infos.add(simInfo);
        }
        if(infos.isEmpty()){
    ...
    private static String getReflexMethod(String predictedMethodName) throws MethodNotFoundException {
        String result = null;
        TelephonyManager telephony = (TelephonyManager) MyApplication.instance.getSystemService(Context.TELEPHONY_SERVICE);
        try {
